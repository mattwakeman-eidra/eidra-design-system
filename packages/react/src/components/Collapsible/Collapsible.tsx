...
const CollapsibleRoot = forwardRef<HTMLDivElement, CollapsibleRootProps>(function CollapsibleRoot(
  { className, ...props },
  ref,
) {
  return <BaseCollapsible.Root ref={ref} className={cn(styles.root, className)} {...props} />;
});
...
const CollapsibleTrigger = forwardRef<HTMLButtonElement, CollapsibleTriggerProps>(
  function CollapsibleTrigger({ className, children, ...props }, ref) {
    return (
      <BaseCollapsible.Trigger ref={ref} className={cn(styles.trigger, className)} {...props}>
        {children}
...
const CollapsiblePanel = forwardRef<HTMLDivElement, CollapsiblePanelProps>(
  function CollapsiblePanel({ className, ...props }, ref) {
    return <BaseCollapsible.Panel ref={ref} className={cn(styles.panel, className)} {...props} />;
  },
);
