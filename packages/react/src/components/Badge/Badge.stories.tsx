    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--eidra-gap-4)' }}>
      <Section label="Subtle">
        <Row>
          ...
          <Badge {...args} variant="subtle" tone="accent">
            Accent
          </Badge>
          <Badge {...args} variant="subtle" tone="coral">
            Coral
          </Badge>
          <Badge {...args} variant="subtle" tone="success">
            Success
          </Badge>
          <Badge {...args} variant="subtle" tone="danger">
            Danger
          </Badge>
          <Badge {...args} variant="subtle" tone="warning">
            Warning
          </Badge>
          <Badge {...args} variant="subtle" tone="info">
            Info
          </Badge>
        </Row>
      </Section>
      <Section label="Solid">
        <Row>
          <Badge {...args} variant="solid" tone="neutral">
            Neutral
          </Badge>
          <Badge {...args} variant="solid" tone="accent">
            Accent
          </Badge>
          <Badge {...args} variant="solid" tone="coral">
            Coral
          </Badge>
          <Badge {...args} variant="solid" tone="success">
            Success
          </Badge>
          <Badge {...args} variant="solid" tone="danger">
            Danger
          </Badge>
          <Badge {...args} variant="solid" tone="warning">
            Warning
          </Badge>
          <Badge {...args} variant="solid" tone="info">
            Info
          </Badge>
        </Row>
      </Section>
      <Section label="Outline">
        <Row>
          <Badge {...args} variant="outline" tone="neutral">
            Neutral
          </Badge>
          <Badge {...args} variant="outline" tone="accent">
            Accent
          </Badge>
          <Badge {...args} variant="outline" tone="coral">
            Coral
          </Badge>
          <Badge {...args} variant="outline" tone="success">
            Success
          </Badge>
          <Badge {...args} variant="outline" tone="danger">
            Danger
          </Badge>
          <Badge {...args} variant="outline" tone="warning">
            Warning
          </Badge>
          <Badge {...args} variant="outline" tone="info">
            Info
          </Badge>
        </Row>
      </Section>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--eidra-gap-4)' }}>
      ...
      <Section label="Contract type">
        <Row>
          ...
          <Badge tone="coral" variant="solid">
            Time & materials
          </Badge>
