...
export interface ComboboxInputProps extends React.ComponentPropsWithoutRef<
...
const ComboboxInput = forwardRef<HTMLInputElement, ComboboxInputProps>(function ComboboxInput(
  ...
  return <BaseCombobox.Input ref={ref} className={cn(styles.input, className)} {...props} />;
});
...
const ComboboxTrigger = forwardRef<HTMLButtonElement, ComboboxTriggerProps>(
  function ComboboxTrigger({ className, ...props }, ref) {
    return <BaseCombobox.Trigger ref={ref} className={cn(styles.trigger, className)} {...props} />;
  },
);

// ---- Icon (chevron inside trigger) ----

export interface ComboboxIconProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Icon
> {
  className?: string;
}

const ComboboxIcon = forwardRef<HTMLDivElement, ComboboxIconProps>(function ComboboxIcon(
  { className, children, ...props },
  ref,
) {
  return (
    <BaseCombobox.Icon ref={ref} className={cn(styles.icon, className)} {...props}>
      {children ?? (
...
export interface ComboboxPositionerProps extends React.ComponentPropsWithoutRef<
...
export interface ComboboxPopupProps extends React.ComponentPropsWithoutRef<
...
const ComboboxList = forwardRef<HTMLDivElement, ComboboxListProps>(function ComboboxList(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.List ref={ref} className={cn(styles.list, className)} {...props} />;
});

// ---- Group ----

export interface ComboboxGroupProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Group
> {
  className?: string;
}

const ComboboxGroup = forwardRef<HTMLDivElement, ComboboxGroupProps>(function ComboboxGroup(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Group ref={ref} className={cn(styles.group, className)} {...props} />;
});

// ---- GroupLabel ----

export interface ComboboxGroupLabelProps extends React.ComponentPropsWithoutRef<
...
const ComboboxGroupLabel = forwardRef<HTMLDivElement, ComboboxGroupLabelProps>(
  function ComboboxGroupLabel({ className, ...props }, ref) {
    return (
      <BaseCombobox.GroupLabel ref={ref} className={cn(styles.groupLabel, className)} {...props} />
    );
  },
);
...
export interface ComboboxItemProps extends React.ComponentPropsWithoutRef<
...
const ComboboxItem = forwardRef<HTMLDivElement, ComboboxItemProps>(function ComboboxItem(
  ...
  return <BaseCombobox.Item ref={ref} className={cn(styles.item, className)} {...props} />;
});

// ---- ItemIndicator ----

export interface ComboboxItemIndicatorProps extends React.ComponentPropsWithoutRef<
...
export interface ComboboxEmptyProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Empty
> {
  className?: string;
}

const ComboboxEmpty = forwardRef<HTMLDivElement, ComboboxEmptyProps>(function ComboboxEmpty(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Empty ref={ref} className={cn(styles.empty, className)} {...props} />;
});

// ---- Clear ----

export interface ComboboxClearProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Clear
> {
  className?: string;
}

const ComboboxClear = forwardRef<HTMLButtonElement, ComboboxClearProps>(function ComboboxClear(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Clear ref={ref} className={cn(styles.clear, className)} {...props} />;
});

// ---- Chips ----

export interface ComboboxChipsProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Chips
> {
  className?: string;
}

const ComboboxChips = forwardRef<HTMLDivElement, ComboboxChipsProps>(function ComboboxChips(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Chips ref={ref} className={cn(styles.chips, className)} {...props} />;
});

// ---- Chip ----

export interface ComboboxChipProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Chip
> {
  className?: string;
}

const ComboboxChip = forwardRef<HTMLDivElement, ComboboxChipProps>(function ComboboxChip(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Chip ref={ref} className={cn(styles.chip, className)} {...props} />;
});

// ---- ChipRemove ----

export interface ComboboxChipRemoveProps extends React.ComponentPropsWithoutRef<
...
const ComboboxChipRemove = forwardRef<HTMLButtonElement, ComboboxChipRemoveProps>(
  function ComboboxChipRemove({ className, ...props }, ref) {
    return (
      <BaseCombobox.ChipRemove ref={ref} className={cn(styles.chipRemove, className)} {...props} />
    );
  },
);
...
export interface ComboboxStatusProps extends React.ComponentPropsWithoutRef<
  typeof BaseCombobox.Status
> {
  className?: string;
}

const ComboboxStatus = forwardRef<HTMLDivElement, ComboboxStatusProps>(function ComboboxStatus(
  { className, ...props },
  ref,
) {
  return <BaseCombobox.Status ref={ref} className={cn(styles.status, className)} {...props} />;
});
